...
const EmployeesAnalytics = () => {
    ...
    const EmployeeData = [
        ["Month", "Incomplete Tasks", { role: 'annotation' }, "Completed Tasks", { role: 'annotation' }],
        ["June", 8.94, 5, 9.94, 2],
    ...
    const WeeklyData = [
        ["Days", "Overtime", { role: 'annotation' }, "Regular", { role: 'annotation' }, "Early Leave", { role: 'annotation' }],
    ...
    return (
        <React.Fragment>
            <Grid container spacing={2} alignItems="center" style={{ marginTop: '3rem' }}>
                <Grid item xl={3} lg={4} md={6} xs={12}>
                    <DashCard cardTitle={'Recruitment Date'} cardIconBG={'rgba(210,239,243,255)'}
                        cardDescription={"10th June '16"} cardIcon={<EmployeeIcon size="1.5em" color="#368292" />} />
                </Grid>
                <Grid item xl={3} lg={4} md={6} xs={12}>
                    <DashCard cardTitle={'Vacation Days Used'} cardIconBG={'rgba(255,244,245,255)'}
                        cardDescription={"8/10"} cardIcon={<EmployeeVacationsIcon size="1.5em" color="#bb5c5a" />} />
                </Grid>
                <Grid item xl={3} lg={4} md={6} xs={12}>
                    <DashCard cardTitle={'Sick Days Used'} cardIconBG={'rgba(254,248,230,255)'}
                        cardDescription={"4/7"} cardIcon={<EmployeeSickIcon size="1.5em" color="#a79048" />} />
                </Grid>
                <Grid item xl={3} lg={4} md={6} xs={12}>
                    <DashCard cardTitle={'Average Task Quality'} cardIconBG={'rgba(240,250,245,255)'}
                        cardDescription={"4.5/5"} cardIcon={<EmployeeTasksIcon size="1.5em" color="#3f8a67" />} />
                </Grid>
            </Grid>

            <Container maxWidth={'xl'}>
                <Grid container spacing={3} alignItems="center" justifyContent="center" style={{ marginTop: '3rem' }}>
            ...
            <EmployeeReview variant="contained" color="primary" disableElevation style={{ position: 'fixed', bottom: '2%', right: '1%' }}>
...
const EmployeeIcon = (props: any) => {
    ...
    return (
        <svg className="svg-icon" width={size} height={size} viewBox="0 0 1024 1024">
            <path fill={color} d="m620.8,521.38667a209.92,209.92 0 0 0 72.53333,-158.72a213.33333,213.33333 0 0 0 -426.66666,0a209.92,209.92 0 0 0 74.66666,158.72a341.33333,341.33333 0 0 0 -200.53333,310.61333a42.66667,42.66667 0 0 0 85.33333,0a256,256 0 0 1 512,0a42.66667,42.66667 0 0 0 85.33334,0a341.33333,341.33333 0 0 0 -202.66667,-310.61333zm-140.8,-30.72a128,128 0 1 1 128,-128a128,128 0 0 1 -128,128z" />
        </svg>
    );
}
